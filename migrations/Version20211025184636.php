 ...
 */
final class Version20211025184636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD editeur_id INT DEFAULT NULL, DROP editeur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE livre ADD editeur VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP editeur_id');
    }
}
